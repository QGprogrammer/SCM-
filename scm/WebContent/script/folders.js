...
[
   {"text":"系统管理", "panelCSS":"panel" ,"textCSS":"textpanel",
       "items":
       [
          {"text":"用户管理","textCSS":"a1", "image":'images/pic/1.gif',    "url":'/scm/scmuser/scmusersServlet', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"},
    ...
    {"text":"采购管理", "panelCSS":"panel" ,"textCSS":"textpanel",
       ...
       [
          ...
          {"text":"采购单管理","textCSS":"a1","image":'images/pic/2.gif',    "url":'gztm/pomain.html', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"},
   ...
   {"text":"仓储管理", "panelCSS":"panel" ,"textCSS":"textpanel",
       ...
       [
		  ...
		  {"text":"库存盘点","textCSS":"a1", "image":'images/pic/9.gif',    "url":'/scm/stock/countServlet', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"},
   ...
   {"text":"财务收支", "panelCSS":"panel" ,"textCSS":"textpanel",
       "items":
       [
          {"text":"收款登记","textCSS":"a1", "image":'images/pic/11.gif',    "url":'/scm/finance/proceedsServlet', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"},
          {"text":"付款登记","textCSS":"a1", "image":'images/pic/12.gif',    "url":'/scm/finance/paymentServlet', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"},
          {"text":"收支查询","textCSS":"a1", "image":'images/pic/13.gif',    "url":'/scm/finance/payAndProSearch.jsp', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"}
   ...
   {"text":"销售管理", "panelCSS":"panel" ,"textCSS":"textpanel",
       ...
       [
		  ...
		  ,
		   {"text":"销售单管理","textCSS":"a1", "image":'images/pic/13.gif',    "url":'gztm/addSale.htm', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"}
		   ,
   ...
   ,
    {"text":"业务报表", "panelCSS":"panel" ,"textCSS":"textpanel",
       ...
       [
          ...
          {"text":"月度收支登记表","textCSS":"a1", "image":'images/pic/12.gif',    "url":'/scm/report/financeReport.jsp', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"},
		  ...
		  ,
		   ...
		   ,
		    {"text":"产品库存报表","textCSS":"a1", "image":'images/pic/13.gif',    "url":'/scm/report/productStockReport.jsp', "classCSS":"imgstyle", "overclassCSS":"imgstyle_over"}
		,
