...
<script type="text/javascript" src="script/finance/proceeds.js"></script>
</head>
</head>
<body>
	<div id="m">
	...
	<table width="100%"  border="0" align="center" cellspacing="1" class="c">
	  ...
	  <c:forEach items="${somainList}"  var="list">
	  <tr>
	  	<td align="center"><a href="javascript:void(0)" onclick="showItem(this)">${list.soId}</a></td>
	  	...
	  	<td align="center">
	  		<c:choose>
	  			...
	  			<c:when test="${list.status=='3'}">已收款</c:when>
...
<div id="item" style="display:none">
	<table width="100%"  border="0" cellpadding="0" cellspacing="0" id="m">
		<tr>
			<td align="center" class="title1" width="100%">销售单详情</td>
		</tr>
		<tr>
